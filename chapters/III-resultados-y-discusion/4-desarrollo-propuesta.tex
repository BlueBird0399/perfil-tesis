...
% \input{chapters/III-resultados-y-discusion/resources/tables/roles-proyecto.tab.tex}
...
\input{chapters/III-resultados-y-discusion/resources/tables/historias-de-usuario.tab.tex}
...
\input{chapters/III-resultados-y-discusion/resources/tables/modelo-historia-de-usuario.tab.tex}

\input{chapters/III-resultados-y-discusion/resources/tables/descripcion-historias-de-usuario.tex}

\begin{landscape}
      \textbf{Estimación de las historias de usuario.}
      \bigbreak

      \input{chapters/III-resultados-y-discusion/resources/tables/estimacion-historias-de-usuario.tab.tex}
\end{landscape}
...
\input{chapters/III-resultados-y-discusion/resources/tables/plan-de-entregas.tab.tex}
...
\input{chapters/III-resultados-y-discusion/resources/tables/historias-primer-periodo.tab.tex}

En la tabla \ref{tab:tareas-i1} se detallan las tareas a realizar en la primera iteración.

\input{chapters/III-resultados-y-discusion/resources/tables/tareas-iteracion-1.tab.tex}
...
En la Figura \ref{fig:prototipo-interfaz-usuario-web-1} se muestra el prototipo de la interfaz de usuario propuesta para
...
\input{chapters/III-resultados-y-discusion/resources/tables/historias-segundo-periodo.tab.tex}

En la tabla \ref{tab:tareas-i2} se detallan las tareas a realizar en la segunda iteración.

\input{chapters/III-resultados-y-discusion/resources/tables/tareas-iteracion-2.tab.tex}
...
\input{chapters/III-resultados-y-discusion/resources/tables/historias-tercer-periodo.tab.tex}

En la tabla \ref{tab:tareas-i3} se detallan las tareas a realizar en la tercera iteración.

\input{chapters/III-resultados-y-discusion/resources/tables/tareas-iteracion-3.tab.tex}
...
\input{chapters/III-resultados-y-discusion/resources/tables/historias-cuarto-periodo.tab.tex}

En la tabla \ref{tab:tareas-i4} se detallan las tareas a realizar en la cuarta iteración.

\input{chapters/III-resultados-y-discusion/resources/tables/tareas-iteracion-4.tab.tex}
...
En la Figura \ref{fig:prototipo-agregar-miembro-mobile} se presenta el prototipo de la interfaz de usuario propuesta para
...
En la Figura \ref{fig:prototipo-notificacion-alerta} se presenta el prototipo de la interfaz de usuario propuesta para
...
En la Figura \ref{fig:prototipo-ubicacion-alerta-mobile} se presenta el prototipo de la interfaz de usuario propuesta para
...
En la Figura \ref{fig:prototipo-ubicacion-alerta-policia} se presenta el prototipo de la interfaz de usuario propuesta para
...
\input{chapters/III-resultados-y-discusion/resources/tables/historias-quinto-periodo.tab.tex}

En la tabla \ref{tab:tareas-i5} se detallan las tareas a realizar en la quinta iteración.

\input{chapters/III-resultados-y-discusion/resources/tables/tareas-iteracion-5.tab.tex}
...
En la Figura \ref{fig:prototipo-cambiar-contrasena-mobile} se muestra el prototipo de la interfaz de usuario propuesta para
...
\input{chapters/III-resultados-y-discusion/resources/tables/tarjetas-crc.tab.tex}
...
\input{chapters/III-resultados-y-discusion/pruebas.tex}
\input{chapters/III-resultados-y-discusion/lanzamiento.tex}