...
\input{chapters/III-resultados-y-discusion/resources/tables/indicadores-perspectivas.tab.tex}
...
% \ref{tab:dimension-tipo-de-incidente} y \ref{tab:dimension-zonas-vigilancia} se presentan las dimensiones y
% sus atributos identificados para el modelo dimensional.

\input{chapters/III-resultados-y-discusion/resources/tables/dimensiones-atributos.tab.tex}
...
\input{chapters/III-resultados-y-discusion/resources/tables/tablas-hechos-atributos.tab.tex}
